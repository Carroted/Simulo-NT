...
import { packageJson, __dirname, __filename, copyFolderRecursiveSync, getPackageName } from './lib.js';

const buildLogPath = path.join(__dirname, 'build-log.json');
const buildInfo = chalk.bold('Building ' + getPackageName(packageJson) + ' v' + packageJson.version + '...\n');
